...
import { Plus, Search, Eye, RefreshCw, Users } from "lucide-react";
                ...
                <TooltipProvider>
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        <Button variant="default" onClick={() => {
                                alert("Add patient — connect to your API")
                            }}>
                                ...
                                {!loading && filtered.map((p) => (
                                    <TableRow key={p.patient_id}>
                                        ...
                                        <TableCell>
                                            ...
                                            {/*
                                                Avatar:
                                                - <AvatarImage> tries to render a <img>; if it fails
                                                (or if src is omitted) <AvatarFallback> shows instead.
                                                - We pass no src here since the API doesn't return photos,
                                                so the fallback (initials) always renders.
                                                - className on AvatarFallback sets the background colour.
                                            */}
                                            <Avatar className="h-9 w-9">
                                                <AvatarImage src={p.photo_url} alt={p.fullname} />
                                        ...
                                        {/* Gender — Badge with outline variant */}
                                        <TableCell>
                                            {/*
                                            Badge variant="outline" renders just a border with no fill.
                                            We layer a className to add gender-specific colours on top.
                                            */}
                                            <Badge
                                            variant="outline"
                                        ...
                                        {/* Sessions — dot indicator + count */}
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                            <span
                                                className={`h-2 w-2 rounded-full ${
                                                (p.sessions ?? 0) > 0 ? "bg-green-500" : "bg-slate-300"
                                                }`}
                                            />
                                        ...
                                        <TableCell>
                                            ...
                                            {/*
                                                Tooltip wraps any trigger + shows a label on hover.
                                                - <TooltipTrigger asChild> passes the tooltip behaviour
                                                down to its child without adding an extra DOM element.
                                                - <TooltipContent> is the floating label.
                                            */}
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                {/*
                                                    Button variant="ghost" → no background until hover.
                                                    size="icon"           → square padding for icon-only buttons.
                                                */}
                                                <Button
                                                    variant="ghost"
                                                    size="icon"
                                                    className="h-8 w-8"
                                                    onClick={() => alert(`View patient ${p.patient_id}`)}
                                                >
                                            ...
                                            <Tooltip>
                                                ...
                                                <Button
                                                    ...
                                                    size="icon"
                                                    className="h-8 w-8"
                                                    onClick={() => alert(`Start session for patient ${p.patient_id}`)}
                                                >
